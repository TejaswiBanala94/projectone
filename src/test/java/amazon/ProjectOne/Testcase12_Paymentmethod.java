...
public class Testcase12_Paymentmethod extends Launch_Quit_Amazon
{
	@Test(retryAnalyzer=utility.RetryLogic.class)
	public void paymentsmethod() throws EncryptedDocumentException, IOException
	{
		...
		WebElement e1 = driver.findElement(By.xpath("(//input[@name='ppw-instrumentRowSelection'])[2]"));
		Assert.assertEquals(e1.isSelected(), true, "Sorry the testcase is failed");
